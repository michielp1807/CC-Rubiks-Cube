...
local relationsBlittle = { [0] = { 8, 4, 3, 6, 5 }, { 4, 14, 8, 7 }, { 6, 10, 8, 7 }, { 9, 11, 8, 0 }, { 1, 14, 8, 0 },
	{ 13, 12, 8, 0 }, { 2, 10, 8, 0 }, { 15, 8, 10, 11, 12, 14 },
	{ 0, 7, 1, 9, 2, 13 }, { 3, 11, 8, 7 }, { 2, 6, 7, 15 }, { 9, 3, 7, 15 }, { 13, 5, 7, 15 }, { 5, 12, 8, 7 },
	{ 1, 4, 7, 15 }, { 7, 10, 11, 12, 14 } }
local relations = {}
for i = 0, 15 do
...
local function drawBuffer(buffer, win)
	...
	for y = 1, floor(height / 3) do
		...
		local blitC1 = { nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil }
		local blitC2 = { nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil }
		local blitChar = { nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, nil, nil, nil, nil, nil }
		for x = 1, maxX do
			local ox = (x - 1) * 2 + 1
			...
			if p1 == p2 and p2 == p3 and p3 == p4 and p4 == p5 and p5 == p6 then
				...
				if look then
					...
					if swapColors then
						...
						blitC1[x] = cC2
						blitC2[x] = cC1
						if lookup[p1] then lookup[p1][sum] = { cC2, cC1, char }
						else lookup[p1] = { [sum] = { cC2, cC1, char } } end
					else
						local cC2 = colorChar[c2]
						local cC1 = colorChar[c1]
						blitC1[x] = cC1
						blitC2[x] = cC2
						if lookup[p1] then lookup[p1][sum] = { cC1, cC2, char }
						else lookup[p1] = { [sum] = { cC1, cC2, char } } end
					end
					blitChar[x] = char
				end
			end
